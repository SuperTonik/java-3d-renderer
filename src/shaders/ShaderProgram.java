...
public abstract class ShaderProgram {
	...
	public ShaderProgram(String vertexFile, String fragmentFile) {
		...
		bindAttributes();					// Bind before starting program.
	...
	/*
	 * Stop programs and detach shaders. Delete shaders and program.
	 */
	public void cleanUp() {
		stop();
	...
	protected void loadMatrix(int location, Matrix4f matrix) {
		matrix.get(matrixBuffer);		// Used to be matrix.store(matrixBuffer);
		//matrixBuffer.flip();		// Not needed with JOML!
